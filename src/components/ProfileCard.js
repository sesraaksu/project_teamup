      ...
      <div className="card-body">
        ...
        {inEditMode && (
          <div>
            ...
            />
            <div>
              <button className="btn btn-primary d-inline-flex mt-2" onClick={onClickSave}>
                <i className="material-icons">save</i>
                {t('Save')}
              </button>
              <button className="btn btn-light d-inline-flex ms-1 mt-2 " onClick={() => setInEditMode(false)}>
